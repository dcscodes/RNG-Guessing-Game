...
if user_choice.isdigit():
    ...
    print(f"Valid answer not given. Only numbers between 0-{range_end} entered as an integer(1,2,3,4,5,6,7,8,9), not spelled out('One','Two','Three', etc), will be accepted.") # ERROR -- INTEGER NOT GIVEN!